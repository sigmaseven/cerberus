...
:loop
    ...
    CALL opencode run "I want you to achieve 100% code coverage for comprehensive testing, including unit testing, integration testing, and smoke testing across ALL code assosicated with frontend and backend, including packages."
